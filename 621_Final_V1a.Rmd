...
```
It does appear that a relationship is possible between the Average Bill to Limit and the default rate. It may also be worthwile to see for how many months the customer's bill increased from one month to the next. This shows how often a customer is spending more than they payoff each month. If this occurs for five consecutive months it may indicate a worsening financial condition.
