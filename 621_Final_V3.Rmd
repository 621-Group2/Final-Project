...
* __Literature Review__ describes similar published research on the topic of financial risk management through the use of data mining and classification to identify credit card default and, a similar and related field, fraud detection  
* __Methodology__ describes the approach and techniques used 
* __Experimentation and Results__ provides an exploratory overview of the dataset and details the results of the models
* __Discussion and Conclusions__ statesconcludes and identifies further areas of work
...
process for building regression models, and your model selection
